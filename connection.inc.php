...
define('INSTAMOJO_KEY', getenv('INSTAMOJO_KEY') ?: 'key');
define('INSTAMOJO_TOKEN', getenv('INSTAMOJO_TOKEN') ?: 'token');
//https://www.youtube.com/watch?v=zWLKQ_loJqI&list=PLWCLxMult9xfYlDRir2OGRZFK397f3Yeb&index=24


define('SMTP_EMAIL', getenv('SMTP_EMAIL') ?: 'vishal0786sandhu@gmail.com');
define('SMTP_PASSWORD', getenv('SMTP_PASSWORD') ?: 'bneauqbbppwvxhdb');
// https://www.youtube.com/watch?v=aBbmo1pi5B0&list=PLWCLxMult9xfY_dsYicKGcCLhlZ6YXFMh&index=1


define('SMS_KEY', getenv('SMS_KEY') ?: 'pVmJMoYOXlLsczICQd6j7qkvFEAiUtg0yDRZ92a13GTw5bHuPhqpeGkdDl5xzvTKVNtcfJ7mMBuRi2Ya');
