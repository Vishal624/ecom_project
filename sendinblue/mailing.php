...
$sendinblue_api_key = getenv('SENDINBLUE_API_KEY') ?: 'api-key-placeholder';
$credentials = SendinBlue\Client\Configuration::getDefaultConfiguration()->setApiKey('api-key', $sendinblue_api_key);
