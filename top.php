				...
				<div class="container">
					<div class="row">
						<div class="menumenu__container clearfix">
							<div class="col-lg-3 col-md-4 col-sm-4 col-xs-5">
								<div class="logo">
									<a href="index.php" class="brand-logo">
										<svg class="logo-mark" width="28" height="28" viewBox="0 0 100 100" fill="none"
											xmlns="http://www.w3.org/2000/svg">
											<rect x="50" y="8" width="58" height="58" transform="rotate(45 50 8)"
												stroke="#c43b68" stroke-width="6" />
											<rect x="50" y="25" width="35" height="35" transform="rotate(45 50 25)"
												fill="#c43b68" />
										</svg>
							...
							<div class="col-md-5 col-lg-6 col-sm-4 col-xs-3">
